...
L["WowSync needs a one-time reset before its API is available. Accept the reset prompt to continue."] = "WowSync needs a one-time reset before its API is available. Accept the reset prompt to continue."
L["empty"] = "empty"
L["Unknown"] = "Unknown"
L["unknown"] = "unknown"
