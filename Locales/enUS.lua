...
L["Activated talent loadout 'X'."] = "Activated talent loadout '%s'."
L["Could not activate talent loadout 'X'."] = "Could not activate talent loadout '%s'."
L["Activated the Starter Build."] = "Activated the Starter Build."
...
L["Developer mode is active."] = "Developer mode is active."
