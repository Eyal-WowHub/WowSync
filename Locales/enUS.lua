...
L["Usage: /ws reset database|db."] = "Usage: /ws reset database|db."
...
L["  /ws reset database|db - Delete all saved profiles and snapshots"] = "  /ws reset database|db - Delete all saved profiles and snapshots"
